  ...
  <div class='content-container'>
    ...
    <div className='subpage-content'>
      ...
      <div class='text'>
        ...
        <h4>Gutsweine</h4>
        <p>
          Das Kennzeichen dieser Weine sind Ertragsreduzierung und schonende Verarbeitung.<br />
          Daraus entstehen unsere vollmundigen, würzigen Weine.
        </p>

        <h4>Premiumweine</h4>
        <p>
          Diese Weine sind geprägt durch ihren An- und Ausbaustil, es sind sehr komplexe Weine mit Reifepotential. Die Weine unserer Premium Edition tragen die
          Namen von heimischen Greifvögeln, in Anlehnung an die Anmut und die Vollendung ihres Gleitfluges. Ganz wie die Vögel stehen auch unsere Weine im
